...
if (isset($_POST['name'], $_POST['password'], $_POST['role'], $_POST['submit'])){
       ...
       $role = $_POST['role'];
    echo $db->updateUsers(['name'=>$name, 'password'=>$password, 'role'=>$role]);
}
...
<?php if(($_SESSION['tables'] == "users" || $_SESSION['tables'] == "attendees") && $_SESSION["role"] == 1)  { ?>
...
<?php if($_SESSION['tables'] == "venues" && $_SESSION["role"] == 1)  { ?>
...
<?php if($_SESSION['tables'] == "events" && ($_SESSION["role"] == 1 || $_SESSION["role"] == 2))  { ?>
...
<?php if($_SESSION['tables'] == "sessions" && ($_SESSION["role"] == 1 || $_SESSION["role"] == 2))  { ?>
